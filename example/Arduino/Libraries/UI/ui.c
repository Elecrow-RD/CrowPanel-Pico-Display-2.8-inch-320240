...
void ui_BEGIN_screen_init(void)
{
    ...
    lv_obj_set_size(ui_toppic, 96, 36);
    lv_obj_set_pos(ui_toppic, 120, 0);
    ...
    lv_img_set_src(ui_dowmpic, &ui_img_1726303309);
    lv_obj_set_width(ui_dowmpic, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_dowmpic, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_size(ui_dowmpic, 110, 18);
    lv_obj_set_pos(ui_dowmpic, 115, 135);
    ...
    // lv_img_set_src(ui_dowmblack, &ui_img_1952474597);
    // lv_obj_set_width(ui_dowmblack, LV_SIZE_CONTENT);   /// 1
    // lv_obj_set_height(ui_dowmblack, LV_SIZE_CONTENT);    /// 1
    // lv_obj_set_size(ui_dowmblack, 106, 14);
    // lv_obj_set_pos(ui_dowmblack, 107, 135);
...
void ui_MENU_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_MENU, &ui_img_391846517, LV_PART_MAIN | LV_STATE_DEFAULT);
